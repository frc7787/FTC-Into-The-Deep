...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double tankAxialP = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.TankDrive.AXIAL_PID.kP;
        public double tankAxialI = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.TankDrive.AXIAL_PID.kI;
        public double tankAxialD = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.TankDrive.AXIAL_PID.kD;
        public double tankCrossTrackP = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.TankDrive.CROSS_TRACK_PID.kP;
        public double tankCrossTrackI = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.TankDrive.CROSS_TRACK_PID.kI;
        public double tankCrossTrackD = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.TankDrive.CROSS_TRACK_PID.kD;
        public double tankHeadingP = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.TankDrive.HEADING_PID.kP;
        public double tankHeadingI = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.TankDrive.HEADING_PID.kI;
        public double tankHeadingD = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.TankDrive.HEADING_PID.kD;

        public double trackingTicksPerRev = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.ThreeWheelLocalizer.TICKS_PER_REV;
        public double trackingWheelRadius = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.ThreeWheelLocalizer.WHEEL_RADIUS;
        public double trackingGearRatio = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.ThreeWheelLocalizer.GEAR_RATIO;
        public double trackingLateralDistance = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.ThreeWheelLocalizer.LATERAL_DISTANCE;
        public double trackingForwardOffset = org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.ThreeWheelLocalizer.FORWARD_OFFSET;
