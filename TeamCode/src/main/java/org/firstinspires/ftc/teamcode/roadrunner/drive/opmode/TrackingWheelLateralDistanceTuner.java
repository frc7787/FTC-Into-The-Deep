...
public class TrackingWheelLateralDistanceTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (!(drive.getLocalizer() instanceof org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.ThreeWheelLocalizer)) {
        ...
        telemetry.addLine("Effective LATERAL_DISTANCE: " +
                (headingAccumulator / (NUM_TURNS * Math.PI * 2)) * org.firstinspires.ftc.teamcode.roadrunner.trajectorysequence.drive.ThreeWheelLocalizer.LATERAL_DISTANCE);
